...
namespace POS.Pages.api.employees
{
    ...
    public class ActivityModel : PageModel
    {
            ...
            try
            {
                ...
                foreach (var activity in employeeActivity)
                {
                    ...
                    if (employee != null)
                    {
                        ...
                        string employeeName = GetDecryptedName(employee);
                ...
                foreach (var staff in allStaff)
                {
                    ...
                    string staffName = GetDecryptedName(staff);
        ...
        private string GetDecryptedName(ApplicationUser user)
        {
            if (user == null)
                return "Unknown";
            ...
            try
            {
                ...
                {
                    return IsValidBase64(user.FullName) 
                        ? _encryptionService.Decrypt(user.FullName) 
                        : user.FullName;
                }
                ...
                {
                    return IsValidBase64(user.UserName)
                        ? _encryptionService.Decrypt(user.UserName)
                        : user.UserName;
                }
                ...
                {
                    return IsValidBase64(user.Email)
