...
namespace POS.Pages
{
    ...
    public class DashboardModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            {
                // Find all elements that represent products
                ProductElements = ActiveTemplate.Elements
                    .Where(e => e.IsProduct && e.ElementType == "Image")
                    .ToList();
            }
        ...
        public async Task<IActionResult> OnPostAddToCartAsync(int elementId, int quantity = 1)
        {
            ...
            // Redirect to the success page instead of setting TempData
